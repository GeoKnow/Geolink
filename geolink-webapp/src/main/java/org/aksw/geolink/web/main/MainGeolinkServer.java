 ...
 * 
 */
public class MainGeolinkServer {
	
	private static final Logger logger = LoggerFactory.getLogger(MainGeolinkServer.class);
	...
	public static void main(String[] args) throws Exception {
		...
		ProtectionDomain protectionDomain = MainGeolinkServer.class.getProtectionDomain();
