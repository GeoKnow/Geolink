...
import org.aksw.jena_sparql_api.geo.LookupServiceUtils;
import org.aksw.jena_sparql_api.geo.MappedConcept;
...
public class GeomizerFactoryLimes {
    ...
    public static List<MappedConcept> candidates = Arrays.asList(GeoMapSupplierUtils.mcOgcGeometry, GeoMapSupplierUtils.mcWgsGeometry);
    ...
    public static MappedConcept detectAvailableMappedConcepts(QueryExecutionFactory sparqlService, List<MappedConcept> mappedConcepts) {
        MappedConcept result = null;
        
        for(MappedConcept mc : mappedConcepts) {
...
//    }
    ...
    public static LookupService<Node, Geometry> createLookupService(KBInfo kbInfo) {
        ...
        MappedConcept mc = detectAvailableMappedConcepts(sparqlService, candidates);
